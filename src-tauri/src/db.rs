...
pub struct NewCompany<'a> {
    ...
    pub regon: Option<&'a str>,
    pub building_number: Option<&'a str>,
    pub flat_number: Option<&'a str>,
    pub county: Option<&'a str>,
    pub post_office: Option<&'a str>,
    pub po_box: Option<&'a str>,
    pub voivodeship: Option<&'a str>,
    pub website: Option<&'a str>,
    pub email: Option<&'a str>,
    pub currency: Option<&'a str>,
    pub initial_balance: Option<&'a str>,
